...
%% File parameters
file.fileName       = 'D_20190602_Megbox_2108';%'File_130'; 
file.fileRoute      = ['P:\GNSS\data file\1027\',file.fileName,'.dat'];  
file.skip        	= 5000; % in unit of ms
solu.iniPos	= [22.3198722/180 * pi, 114.20910277777778/180 * pi, 4]; 
...
%% Signal parameters
signal.IF               =0;%1580e6-1575.42e6;%0;   % unit: Hz 
signal.Fs               =26e6;%58e6;  	% unit: Hz
...
cmn.mltCorrON = [0 0]; %% 0: disable multicorr; 1: enable mltCorr; cmn.mltCorrON(1): CT;    %cmn.mltCorrON(1): CT   ;  cmn.mltCorrON(2): VT  
                                            % Suggested STEPS:
